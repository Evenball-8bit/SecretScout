...
;THE FOLLOWING EQUATES ARE USED TO MAKE MUSIC STRINGS.
	...
	N16 = %00000000		;NOTE DURATIONS.  USE BY ADDING (Gs+N16)
	N8 = %00100000
	N4 = %01000000
	N2 = %01100000
	N1 = %10000000
	...
	SOUNDLOOP = %11000000	;LOOP COMMAND
	NODRUMS = %11000010	;DISALLOW DRUMS IN THIS VOICE CHANNEL
	ALLOWDRUMS = %11000011
	...
	PERCUSSION = %11111000	;USED TO SELECT THE PERCUSSION INSTRUMENTS

	LOADALL = %11111001	;USED TO SPECIFY LOADING ALL 4 REGS

	WAIT = %11111011		;USED TO DELAY AFTER LOADALL OR LOADREGx
...
;THE TABLE OF REGISTER LOADS SPECIFIES THE BASE REGISTER TO BE USED.
	...
	BSD0 = 0		;BASE DRUM FOR VOICE 0
	BSD1 = 1		;BASE DRUM FOR VOICE 2
	TOM0 = 2		;TOM DRUM FOR VOICE 0
	TOM1 = 3		;TOM DRUM FOR VOICE 1
	SN0 = 4		;SNARE FOR VOICE 0
	SN1 = 5		;SNARE FOR VOICE 2
	RIM = 6		;RIM SHOT
	BRS = 7		;BRUSH
	HIBELL = 8	;HIGH BELL
	TRI = 9		;HIGH TRIANGLE
	HH = 10		;HIGH HAT VOICE 3
	TOM2 = 11		;TOM DRUM FOR VOICE 2
	HITOM0 = 12	;HIGH TOM FOR VOICE 0
	HITOM1 = 13	;HIGH TOM FOR VOICE 1
	LOWTOM0 = 14	;HIGH TOM FOR VOICE 0
	LOWTOM1 = 15	;HIGH TOM FOR VOICE 1

;THE FORMAT OF THIS TABLE IS:
;1 BYTE BASE REGISTER, 4 BYTES VALUES TO WRITE THERE.

	PERCENABLE = %00001111	;VOICES TO ENABLE FOR PERCUSSION
...
;.ORG	32224	;(7DE0H)
;	' )
;I'm disabling all .ORGs - Evenball
