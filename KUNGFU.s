...
.ifndef BLOCKMODE;IFDEF( `BLOCKMODE', , `		
...
MSR20:	LDA	XBACK		;IF ON COMMAND, GET ODD PIXELS OF SCROLL
	...
	STA	SUBSVAR6
;******************************************************************
	LDA	SUBSVAR4	;Odd! It seems this code is repeated in bank 2 - Evenball
...
FCB15:	LDY	#0	
	...
	TAX
FCB17:	STX	a:SUBSVAR1	;RETURN THE COUNT BYTE
